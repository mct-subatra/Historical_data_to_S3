...
if __name__ == '__main__':
    ...
    # csv_file_path = r'wind_data.csv'  # Update this with the path to your CSV file
    # with open(csv_file_path, 'r') as file:
    #   csv_reader = csv.reader(file)
    # csv_content = list(csv_reader)
    csv_content = pd.read_csv("aws-iot-device-sdk-python-v2/samples/wind_data.csv")
    ...
    # This step loops forever if count was set to 0.
     ...
     #   if message_count == 0:
            #print("Sending messages until the program is killed")
      #  else:
